...
int a = 0 ; //Link angle at set up shoulder for potentiometer

int b = 0; //Link angle at set up elbow for potentiometer

int a1 ;  // Link angle at that value 

int b1 ; //Link angle at that value 
